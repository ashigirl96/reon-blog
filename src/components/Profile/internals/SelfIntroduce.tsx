  ...
  return (
    <div className="flex justify-center gap-x-4 flex-col xl:flex-row gap-y-4">
      ...
      <div className="flex justify-center mx-4">
        <article className="xl:mx-0 prose max-w-xl">
          <p>
            西村礼恩(Reon
            ...
            <h3>仕事</h3>
            <p>
              現在は株式会社メドレーに所属しており、オンライン診療システムや予約システムの開発をしています。弊チームでは、特定の技術にこだわることなく様々な技術スタックに触れる機会が多いです。
              インフラからフロントエンドまで触る中で、特にフロントエンドの技術に興味を持っています。
              あるフロントエンドフレームワークから別のフレームワークに移行する必要に迫られたとき、その移行プロジェクトを任せられ、推進できたのが大きな経験になりました。
            </p>
            <h3>趣味・好きなもの</h3>
